...
gg<- gg + geom_point(aes(x=dfall$T, y=dfall$V))
gg<- gg + geom_errorbar(aes(x=dfall$T, ymin=dfall$V-dfall$dV, 
                        ymax=dfall$V+dfall$dV))
fig<-myplotly(gg,"","T[K]","$\\langle V \\rangle$",to_print = TRUE)
```
